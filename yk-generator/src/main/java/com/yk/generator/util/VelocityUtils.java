...
public class VelocityUtils {
    ...
    public static VelocityContext prepareContext(GenTable genTable) {
        ...
        velocityContext.put("datetime", TimeUtils.getCurrentDatetime());
    ...
    private static HashSet<String> getImportList(List<GenTableColumn> columns) {
        ...
        for (GenTableColumn column : columns) {
            ...
            } else if (!column.commonColumn() && GenConstants.TYPE_BIGDECIMAL.equals(column.getJavaType())) {
